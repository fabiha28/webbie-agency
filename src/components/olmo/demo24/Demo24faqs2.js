            ...
            <div className="col">
              <div className="questions-holder pr-15">
                ...
                <div className="question wow fadeInUp">
                  {/* Question */}
                  <h5 className="h5-md">
                    هل يمكنني رؤية olmo أثناء العمل قبل الشراء؟
                  </h5>
                  {/* Answer */}
                  <p className="p-lg">
                ...
                <div className="question wow fadeInUp">
                  {/* Question */}
                  <h5 className="h5-md">
                    هل يمكنني استخدام olmo على أجهزة مختلفة؟
                  </h5>
                  {/* Answer */}
                  <ul className="simple-list">
                    <li className="list-item">
                      <p className="p-lg">
                        لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل
                        وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر. كان
                        لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن
                        الخامس عشر
                      </p>
                    </li>
                    <li className="list-item">
          ...
          <div className="col">
            <div className="more-questions">
              <h5 className="h5-sm">
                ...
                <Link href="/contacts">اطرح سؤالك هنا</Link>
              </h5>
            </div>
          </div>
        </div>
