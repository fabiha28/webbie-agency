...
const HomeHeader = ({
  ...
  return (
    <header
      id="header"
      className={`header tra-menu ${navLight ? "navbar-light" : "navbar-light"}`}
    >
            ...
            <nav className="wsmenu clearfix">
              ...
              >
                ...
                <li>
                  ...
                  <Link href={`${singlePage ? "/about" : "#"}`}>
                    <a>Projects {!singlePage && <span className="wsarrow" />}</a>
                  </Link>
                  {!singlePage && (
                    <ul
                      className="sub-menu"
                ...
                <li>
                  ...
                  <Link href={`${singlePage ? "/about" : "#"}`}>
                    <a>Services {!singlePage && <span className="wsarrow" />}</a>
                  </Link>
                  {!singlePage && (
                    <ul
                      className="sub-menu"
